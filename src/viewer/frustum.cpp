...
Mat4 projection_matrix(const CameraFrustum& frustum)
{
  if (!frustum.is_ortho)
  {
    return perspective_matrix(frustum.aspect_x,
                              frustum.aspect_y,
                              frustum.shift_x,
                              frustum.shift_y,
                              frustum.near,
  ...
  {
    return orthographic_matrix(frustum.aspect_x,
                               frustum.aspect_y,
                               frustum.shift_x,
                               frustum.shift_y,
                               frustum.near,
...
Mat4 projection_matrix_inv(const CameraFrustum& frustum)
{
  if (!frustum.is_ortho)
  {
    return perspective_matrix_inv(frustum.aspect_x,
                                  frustum.aspect_y,
                                  frustum.shift_x,
                                  frustum.shift_y,
                                  frustum.near,
  ...
  {
    return orthographic_matrix_inv(frustum.aspect_x,
                                   frustum.aspect_y,
                                   frustum.shift_x,
                                   frustum.shift_y,
                                   frustum.near,
